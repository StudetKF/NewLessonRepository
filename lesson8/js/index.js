...
function getWalls(){
    walls_pos = [];
    walls_pos.lenght = getRandomInt(0,parseInt((row+col)/2));
    for(let i=0; i<walls_pos.lenght;i++){
...
function getDelApple(){
    let apple_del = document.getElementsByClassName("apple");
    while(apple_del[0]!=undefined){
        apple_del[0].classList.remove('apple');
    }
    getSnakePlus();
    score+=1;
    getScore();
...
function getLose(){
    let wall1 = document.getElementsByClassName("wall");
    while (wall1[0] != undefined){
        wall1[0].classList.remove('wall');
    }
    let snake_now = document.getElementsByClassName("snake");
    while (snake_now[0]!=undefined){
        snake_now[0].classList.remove('snake');
    }
    getDelApple();
    snake_length=3;
    score =0;
